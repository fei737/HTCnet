...
def inspect_split(root, split, label_dir_name, hha_dir_name, n_classes, max_samples):
    ...
    for image_name in sample_ids:
        ...
        hha_path = os.path.join(root, hha_dir_name, f"{base}.png")
...
def main():
    ...
    required_dirs = ["RGB", args.hha_dir_name, args.label_dir_name]
